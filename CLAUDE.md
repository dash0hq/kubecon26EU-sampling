...
When asked about generating code or configurations, always used the relevant skills from `dash0hq/agent-skills`.
...
Markdown tables need to always be correctly formatted.
